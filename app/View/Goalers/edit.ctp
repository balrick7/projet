...
<?php echo $this->Form->create('Goaler'); ?>
	<fieldset>
		<legend><?php echo __('Edit Goaler'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Goaler.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Goaler.id'))); ?></li>
