...
<?php echo $this->Form->create('AllignmentsDefence'); ?>
	<fieldset>
		<legend><?php echo __('Edit Allignments Defence'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AllignmentsDefence.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('AllignmentsDefence.id'))); ?></li>
