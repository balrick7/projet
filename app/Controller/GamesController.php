 ...
 */
	public function add() {
		...
		$typegames = $this->Game->Typegame->find('list');
		$schedules = $this->Game->Schedule->find('list');
		$vleaguesTeams = $this->Game->VleaguesTeam->find('list');
		$hleaguesTeams = $this->Game->HleaguesTeam->find('list');
		$players = $this->Game->Player->find('list');
		$this->set(compact('typegames', 'schedules', 'vleaguesTeams', 'hleaguesTeams', 'players'));
	}
